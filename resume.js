...
skillsTechDiv.classList.add("flex-container")
...
skillsMarketDiv.classList.add("flex-container")
...
projectsDiv.append(projectSectionDiv, projectsDetailDiv, projectsLocationDiv, realizationOneDiv, realizationTwoDiv, realizationThreeDiv, newLine, projectsDetailSecondDiv, projectsLocationSecondDiv, realizationOneSecondDiv, realizationTwoSecondDiv, realizationThreeSecondDiv)
...
secondRowOneLeftP.textContent = 'Hubler Ford'
...
secondRowTwoDiv.append(secondRowTwoLeftP)
...
workRealizationOneSecondP.textContent = 'Performing six (6) sided checks on item to avoid sending incorrect to customer'
...
workRealizationTwoSecondP.textContent = 'Inspect working condition of my Order Picker to avoid possible issues or/and dowmturn'
...
workRealizationThreeSecondP.textContent = 'Always read my scanner to avoid mistakes'
workRealizationThreeFirstDiv.append(spanWorkRealizationThreeSecond, workRealizationThreeSecondP)
...
workDiv.append(workHeaderDiv, firstRowOneDiv, firstRowTwoDiv, workRealizationOneFirstDiv, workRealizationTwoFirstDiv, workRealizationThreeFirstDiv)


// Work experience : Begin ===============================

resumeBodyDiv.append(educationDiv, skillsDiv, projectsDiv, workDiv)
